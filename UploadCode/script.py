...
media_dir='/home/gramvaani/backup/media'
...
#	transcript=transcript.encode('utf-8')
	...
	if ((state == 'ARC') or (state == 'PUB')):
		...
		cursor.execute (u"INSERT INTO " + " goonj_story " + u""" (location_id,story_type,story_id,title,transcript,audio,video,views_count,date,rating,top_story,related_stories,ai_id, detail_id,tags,is_comment,is_src_caller,location_text)
		 VALUES(%s, 'NON_EVENT',%s,%s,%s,%s,NULL,0,%s,3,0,NULL,%s,%s,%s,%s,%s,%s) """,(location,story_id,title,transcript,audio,date,ai_id,detail_id,tags,is_comment,is_src_caller,location_text))
